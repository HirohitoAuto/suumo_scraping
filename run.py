...
# 東京23区
base_url = "https://suumo.jp/jj/chintai/ichiran/FR301FC001/?ar=090&bs=040&ra=040&cb=0.0&ct=9999999&et=9999999&cn=9999999&mb=0&mt=9999999&shkr1=03&shkr2=03&shkr3=03&shkr4=03&fw2=&ek=703577040&rn=7035&page={}"
...
for page in range(1, max_page + 1):
    ...
    for item in items:
        ...
        for station in stations:
            ...
            base_data["アドレス"] = (
                item.find("li", {"class": "cassetteitem_detail-col1"}).getText().strip()
            )
            ...
            for tbody in tbodys:
                ...
                data["URL"] = "https://suumo.jp" + tbody.findAll("td")[8].find("a").get(
                    "href"
                )
